 ...
 */
public class WaiterAccountController implements Initializable {
    private static final Logger logger = Logger.getLogger(WaiterAccountController.class.getName());
